...
<% } %>
  ...
  File 1 Type: <select name=fileType><option></option><option>Image</option><option>Annotation</option><option>Template</option></select><br>
  <br>
  File 2: <input type=file name=file2><br>
  File 2 Description: <input type=text name=description size=30><br>
  File 2 Type: <select name=fileType><option></option><option>Image</option><option>Annotation</option><option>Template</option></select><br>
  <br>
  File 3: <input type=file name=file3><br>
  File 3 Description: <input type=text name=description size=30><br>
  File 3 Type: <select name=fileType><option></option><option>Image</option><option>Annotation</option><option>Template</option></select><br>
  <br>
  File 4: <input type=file name=file4><br>
  File 4 Description: <input type=text name=description size=30><br>
  File 4 Type: <select name=fileType><option></option><option>Image</option><option>Annotation</option><option>Template</option></select><br>
  <br>
...
<% } else if (studyUID == null) { %>
	var url = "<%=request.getContextPath()%>/v2/projects/<%=projectID%>/subjects/<%=subjectID%>/files/";
<% } else if (seriesUID == null) { %>
	var url = "<%=request.getContextPath()%>/v2/projects/<%=projectID%>/subjects/<%=subjectID%>/studies/<%=studyUID%>/files/";
<% } else { %>
	var url = "<%=request.getContextPath()%>/v2/projects/<%=projectID%>/subjects/<%=subjectID%>/studies/<%=studyUID%>/series/<%=seriesUID%>/files/";
<% } %>
	//alert(url);
	$.ajax({         
