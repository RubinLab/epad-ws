...
import edu.stanford.isis.dicomproxy.db.mysql.MySqlConnectionPool;
...
public class MySqlQueriesImpl implements MySqlQueries{
    ...
    public List<Map<String, String>> getUnprocessedPngFilesSeries(String seriesIUID) {
        ...
        try{
            ...
            logger.info("getImagesWithoutPngFile... has: "
                    +allImagesWithFiles.size()+" images with files and "
    ...
    public void insertEventInDb(String userName, String event_status,String aim_uid, String aim_name,String patient_id,String patient_name,String template_id,String template_name,String plugin_name) {
        Connection c = null;
        PreparedStatement ps = null;
        try{
    ...
    public float getPercentComplete(String seriesUID) {
        ...
        float percent = (float)(nPngFiles/nInstances);
        return percent;
    }
    ...
    public static Map<String,String> createResultMap(ResultSet resultSet)
        throws SQLException
    {
        Map<String,String> retVal = new HashMap<String, String>();
