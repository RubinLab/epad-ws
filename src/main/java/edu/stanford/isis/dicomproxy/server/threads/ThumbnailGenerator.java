...
public class ThumbnailGenerator implements Runnable
{
    ...
    public void run() {
        ...
        try{
            ...
            while( !signal.hasShutdown() ){
                ...
                WadoUrlBuilder wadoUrlBuilder = new WadoUrlBuilder(host,port,base,WadoUrlBuilder.Type.IMAGE);
     ...
     */
    private File createThumbnailFile(DicomStudyUID studyUID, DicomSeriesUID seriesUID)
        throws IOException
    {
...
/**
 * http://rufus.stanford.edu:8080/wado?requestType=WADO&studyUID=1.2.752.24.7.19011385.453825&seriesUID=1.2.840.113704.1.111.424.1207241028.11&objectUID=1.2.840.113704.1.111.3820.1207241475.1612&contentType=image/jpeg&windowCenter=100&windowWidth=350&rows=512&columns=512&region=0.1,0.1,0.9,0.9
 */
