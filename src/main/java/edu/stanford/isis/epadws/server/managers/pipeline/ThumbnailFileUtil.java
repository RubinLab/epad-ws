...
public class ThumbnailFileUtil {
    ...
    {
        return DicomFormatUtil.createDicomDirPath(studyId)
                +"/thumbnail_"+DicomFormatUtil.formatUidToDir(seriesId)+".jpg";
    }//createThumbnailPath
    ...
    public static String createJPEGPath(String studyId, String seriesId, String sopInstanceId){
        return DicomFormatUtil.createDicomDirPath(studyId, seriesId)
                +"/"+DicomFormatUtil.formatUidToDir(sopInstanceId)+".jpg";
    }//createJPEGPath
        ...
        try{
            ...
            else
            {
                ...
                else
                {
                    ...
                    /*
                     * The JPEGImageEncoder and JPEGCodec classes used here
                     * are part of the internals of the Java run time and will not
                     * necessarily be the same for all implementations.  ImageIO should
                     * be used (with a very few exceptions) to get the ImageWriter and
                     * ImageReader objects.
