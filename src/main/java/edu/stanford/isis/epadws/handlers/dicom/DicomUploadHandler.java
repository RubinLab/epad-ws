 ...
 * <p>
 * Now handled by Restlet resource {@link DICOMUploadServerResource}.
 * 
 * @author amsnyder
 * @see DICOMUploadServerResource
 */
public class DicomUploadHandler extends AbstractHandler
{
	...
	@Override
	public void handle(String s, Request request, HttpServletRequest httpServletRequest, HttpServletResponse httpResponse)
