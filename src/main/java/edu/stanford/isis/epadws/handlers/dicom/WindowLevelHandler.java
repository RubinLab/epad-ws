...
/**
 * This is a speculative code that creates leveled jpegs on the server side. It will have the following params wl -
 * window level or sometimes called window center. range 0 to 4096 ww - window width. range 0 to 4096 seriesuid - The
 * series UID. Something like 1.2.456.76.34 order - Which image in the stack it is. range 1 to max image number.
...
public class WindowLevelHandler extends AbstractHandler
{
	 ...
	 * @return PrintWriter
	 */
	private PrintWriter handleCreateLevelJpegs(HttpServletRequest req, HttpServletResponse res) throws IOException,
	 ...
	 * @return PrintWriter
	 */
	private PrintWriter handleQueryLeveledJpegs(HttpServletRequest req, HttpServletResponse res) throws IOException
	{
		String wl = req.getParameter("wl");
		String ww = req.getParameter("ww");
		String seriesuid = req.getParameter("seriesuid");
