 ...
 * (to be compatible with the older "ord" file format.
 *
 ...
 *
 * filename is    - sopInstanceUID with .dcm at end.  sop_iuid in instance table.
 * order          - inst_no in instance table.
 * Slice Location - inst_custom1  field in instance table
 * Content Time   - Doesn't seem to be used for now, so will set to 'null'.
 *
