...
public class SearchHandler extends AbstractHandler
{
	...
	private final ProxyWorkers proxyWorkers = ProxyWorkers.getInstance();
	...
	/**
	 * Add this seriesId to the thumbnail generator queue to start the process of creating a thumbnail image.
	 * 
