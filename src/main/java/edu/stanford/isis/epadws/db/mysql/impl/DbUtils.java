...
public class DbUtils {
    ...
    /**
     * Returns a default value if an optional number is null. If the optional value isn't a
     * valid integer log a warning and return the default value.
    ...
    public static int toOptionalInt(String optionalValue, int defaultValue){
        if(optionalValue==null) return defaultValue;
        try{
    ...
    /**
     * The date-time format arrives as YYYYMMDD-HHMMSS.mmmmm and needs to be turned into YYYYMMDD
     * to match RSNA format.
    ...
    /**
     * The date-time format arrives as YYYY-MM-DD HH:MM:SS.mmmmm and needs to be turned into YYYYMMDD
     * to match RSNA format.
    ...
    public static void logKey(String name,int key, String searchValue){
        ...
        /**
     * Takes multiple database create commands from a single string and turns them into multiple
     * commands. It expects to see the SQL commands in the following format.
     *
     *
     *
