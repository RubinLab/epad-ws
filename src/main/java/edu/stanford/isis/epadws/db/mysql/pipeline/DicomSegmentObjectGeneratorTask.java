...
public class DicomSegmentObjectGeneratorTask implements GeneratorTask
{
	...
	static final String baseDicomDirectory = "/home/epad/DicomProxy/resources/dicom/";

	File dicomInputFile;
	File segObjectOutputFile;
	...
	public void run() {
		...
		String studyId = (String) ids.get("study-id");
		String seriesId = (String) ids.get("series-id");
		String imageId = (String) ids.get("sop-inst-id");
		String objectId = (String) ids.get("ref-sop-inst-id");
	...
	private void generateAIMSegmentationFile(File tagFile) throws Exception {
		...
		ImageAnnotation imageAnnotation =new ImageAnnotation(
				0, "", "2012-10-17T10:22:40", "segmentation", 
				"SEG", "SEG Only", "", 
				"", "");
...
//<?xml version="1.0"?>
//<ImageAnnotation xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" dateTime="2012-10-24T11:03:31" uniqueIdentifier="1.2.276.0.7230010.3.1.3.2225507198.6232.1351101811.798" xmlns="gme://caCORE.caCORE/3.2/edu.northwestern.radiology.AIM" codingSchemeDesignator="na" codeMeaning="na" aimVersion="3.0" xsi:schemaLocation="gme://caCORE.caCORE/3.2/edu.northwestern.radiology.AIM AIM_v3_rv11_XML.xsd" codeValue="na" name="NA__2012-10-24T11:03:31" cagridId="0">
// <user>
//  <User numberWithinRoleOfClinicalTrial="1" loginName="" roleInTrial="Performing" name="" cagridId="0"/>
// </user>
// <equipment>
//  <Equipment softwareVersion="Slicer 4.1.0-2012-10-22 r21223 Reporting 7cbc2f3" manufacturerName="Brigham and Women's Hospital, Surgical Planning Lab" cagridId="0" manufacturerModelName="3D_Slicer_4_Reporting"/>
// </equipment>
// <anatomicEntityCollection>
//  <AnatomicEntity annotatorConfidence="0.0" codingSchemeDesignator="3DSlicer" codeMeaning="tissue" codeValue="1" label="tissue" cagridId="0"/>
// </anatomicEntityCollection>
// <segmentationCollection>
//  <Segmentation sopClassUID="1.2.840.10008.5.1.4.1.1.66.4" referencedSopInstanceUID="" segmentNumber="1" sopInstanceUID="1.2.276.0.7230010.3.1.4.2225507198.6232.1351101812.800" cagridId="0"/>
// </segmentationCollection>
