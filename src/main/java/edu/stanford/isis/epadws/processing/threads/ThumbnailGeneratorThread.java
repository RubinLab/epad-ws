 ...
 */
package edu.stanford.isis.epadws.processing.threads;
 ...
 * @author amsnyder
 */
public class ThumbnailGeneratorThread implements Runnable
{
	...
	public ThumbnailGeneratorThread(BlockingQueue<DicomSeriesUID> queue)
	{
		inputQueue = queue;
