...
public class DbCalls
{
	...
	public static final String PS_INSERT_ISSUER = "INSERT INTO issuer(" + "entity_id, entity_uid, entity_uid_type) "
			+ "VALUES(?,?,?)";
	...
	public static final String PS_INSERT_STUDY = "INSERT INTO study("
			...
			+ "ref_physician ,study_desc ,created_time) " + "VALUES(?,?,?,?,?,?,?,?,?)";
	...
	public static final String PS_INSERT_STUDY_ON_FS = "INSERT INTO study_on_fs("
			+ "study_fk ,filesystem_fk ,access_time ,mark_to_delete) " + "VALUES(?,?,?,?)";

	public static final String PS_INSERT_ANNOTATIONS = "INSERT INTO annotations(" + "instance_fk ,aim_uid) "
			+ "VALUES(?,?)";
