...
public class EpadStatisticsMonthly extends AbstractDAO {
	...
	public void addStatistics(EpadStatisticsMonthly other) {
	...
	public final static String DBTABLE = "epadstatistics_monthly";
