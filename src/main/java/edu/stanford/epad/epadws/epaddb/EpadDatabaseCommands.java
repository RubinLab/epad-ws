...
public interface EpadDatabaseCommands
{
	...
	public static final String SELECT_EPAD_FILE_PATH_FOR_IMAGE = "SELECT file_path from epaddb.epad_files as f, pacsdb.instance as i where sop_iuid=? and i.pk = f.instance_fk";
