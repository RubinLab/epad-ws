			...
			if (validSession || debug) {
				...
				if ((user != null && user.isAdmin()) || debug) {
					...
					for (String id: sessions.keySet()) {
						...
						responseStream.println("<tr><td>" + session.getUsername() + you + "</td><td nowrap>" + shortformat.format(session.getCreatedTime()) + "</td><td nowrap>" + session.getRemoteHost() + "/" + session.getRemoteAddr() + "</td><td>" + session.getLastRequest() + "</td><td nowrap>" + shortformat.format(session.getLastActivity()) + "</td></tr>");
					}
					responseStream.println("</table>");
