...
public class ProjectsRouteTemplates
{
	...
	public static final String SUBJECT_FILE_LIST = PROJECT + "/files/";
	public static final String SUBJECT_FILE = PROJECT_FILE_LIST + "{filename}";
	...
	public static final String SERIES_FILE_LIST = PROJECT + "/files/";
	public static final String SERIES_FILE = PROJECT_FILE_LIST + "{filename}";
