...
public class PluginStartTask implements Runnable
{
	...
	public PluginStartTask(String jsessionID, String pluginName, String annotationID, int frameNumber)
	{
	...
	public void run()
	{
        ...
        String url = "http://localhost:8080/epad/plugin/" + pluginName + "/?aimFile=" + annotationID + "&frameNumber=" + frameNumber;
